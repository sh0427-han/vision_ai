...
PAGE_TERMS = {
    "pixels": [
        ...
        ("HWC", "Height, Width, Channel", "높이·너비·채널 순서의 이미지 배열"),
        ("CHW", "Channel, Height, Width", "채널·높이·너비 순서의 이미지 Tensor"),
        ("NCHW", "Batch, Channel, Height, Width", "배치·채널·높이·너비 순서의 Tensor"),
...
SECTION_VISUALS = {
    ...
    ("pixels", "resize"): ["pixels-resize.svg"],
