...
note('pixels', '이미지는 어떻게 숫자가 될까?', '픽셀, RGB, 텐서, 정규화. 모델에 들어가는 입력을 숫자의 관점에서 이해합니다.', '핵심 주제', '01 · IMAGE & TENSOR', 15, [
...
note('cnn', 'CNN: 합성곱에서 ResNet까지', '합성곱·채널·수용영역을 이해한 뒤, 대표 CNN 아키텍처인 ResNet의 residual learning까지 연결합니다.', '핵심 주제', '02 · CNN & RESNET', 22, [
...
note('vit', 'Transformer Vision: Attention에서 ViT까지', '패치·토큰·Q/K/V·self-attention을 먼저 이해하고, Vision Transformer 논문을 대표 사례로 연결합니다.', '핵심 주제', '03 · TRANSFORMER & VIT', 30, [
...
note('tasks', 'Vision Tasks: 분류·탐지·분할과 U-Net', '출력 형식과 평가 기준을 먼저 구분하고, segmentation의 대표 구조인 U-Net까지 연결합니다.', '핵심 주제', '04 · VISION TASKS & U-NET', 15, [
...
note('training', '학습·검증·평가를 구분하는 기준', '데이터 누수, 클래스별 분포, 교차검증과 임계값. 성능 숫자가 무엇을 의미하는지 확인합니다.', '핵심 주제', '05 · TRAINING & EVALUATION', 22, [
...
note('resnet', 'ResNet: 입력을 더하면 무엇이 달라질까?', 'Deep Residual Learning for Image Recognition의 문제의식과 잔차 블록을 수식·구조·예시로 설명합니다.', '핵심 주제', '06 · RESIDUAL LEARNING', 20, [
...
note('unet', 'U-Net: 의미와 위치 정보를 다시 연결하기', 'U-Net 논문의 수축·확장 경로, skip connection, 원본 구조의 크롭을 구분해 설명합니다.', '핵심 주제', '07 · DENSE PREDICTION', 20, [
...
note('patchcore', 'Anomaly Detection: 정상 특징에서 PatchCore까지', '정상 데이터 기반 이상 탐지의 문제를 먼저 정의하고, PatchCore의 memory bank·coreset·최근접 거리 방식을 대표 사례로 설명합니다.', '핵심 주제', '06 · ANOMALY DETECTION', 22, [
...
def render():
    ...
    group_subtitles = {
        '핵심 주제': '입력 · CNN · Transformer · Tasks · 학습 · 이상탐지',
        '강의·교과서 정리': 'CS231n · PRML을 큰 흐름으로 다시 연결',
    }
    for group in ['핵심 주제', '강의·교과서 정리']:
